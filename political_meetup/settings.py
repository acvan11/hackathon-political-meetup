"""
Django settings for political_meetup project.
...
SECRET_KEY = 'w7^n(@vtr%u@qlz7@)4wft(exmbj(sojdf811ykci2d10t#=+1'
...
ROOT_URLCONF = 'political_meetup.urls'
...
WSGI_APPLICATION = 'political_meetup.wsgi.application'
